...
BEGIN
    INSERT_ESTADO_TB_SP(0, 'Inactivo');
    INSERT_ESTADO_TB_SP(1, 'Activo');
END;
/
-- Inserciones FIDE_DIRECCION_PROVINCIA
BEGIN
    INSERT_DIRECCION_PROVINCIA_TB_SP(1, 'San Jose');
    INSERT_DIRECCION_PROVINCIA_TB_SP(1, 'Alajuela');
    INSERT_DIRECCION_PROVINCIA_TB_SP(1, 'Cartago');
    INSERT_DIRECCION_PROVINCIA_TB_SP(1, 'Heredia');
    INSERT_DIRECCION_PROVINCIA_TB_SP(1, 'Guanacaste');
    INSERT_DIRECCION_PROVINCIA_TB_SP(1, 'Puntarenas');
    INSERT_DIRECCION_PROVINCIA_TB_SP(1, 'Limon');
END;
/
-- Inserciones FIDE_DIRECCION_CANTON_TB
BEGIN
    INSERT_DIRECCION_CANTON_TB_SP(101, 1, 'San Jose');
    INSERT_DIRECCION_CANTON_TB_SP(102, 1, 'Escazu');
    INSERT_DIRECCION_CANTON_TB_SP(118, 1, 'Curridabat');
    INSERT_DIRECCION_CANTON_TB_SP(203, 1, 'Grecia');
    INSERT_DIRECCION_CANTON_TB_SP(308, 1, 'El Guarco');
    INSERT_DIRECCION_CANTON_TB_SP(403, 1, 'Santo Domingo');
    INSERT_DIRECCION_CANTON_TB_SP(407, 1, 'Belen');
    INSERT_DIRECCION_CANTON_TB_SP(409, 1, 'San Pablo');
    INSERT_DIRECCION_CANTON_TB_SP(602, 1, 'Esparza');
    INSERT_DIRECCION_CANTON_TB_SP(609, 1, 'Parrita');
    INSERT_DIRECCION_CANTON_TB_SP(611, 1, 'Garabito');  
END;
/
-- Inserciones FIDE_DIRECCION_DISTRITO_TB
BEGIN
    INSERT_DIRECCION_DISTRITO_TB_SP(10105, 1, 'Zapote');
    INSERT_DIRECCION_DISTRITO_TB_SP(10107, 1, 'Uruca');
    INSERT_DIRECCION_DISTRITO_TB_SP(10203, 1, 'San Rafael');
    INSERT_DIRECCION_DISTRITO_TB_SP(11801, 1, 'Curridabat');
    INSERT_DIRECCION_DISTRITO_TB_SP(11802, 1, 'Granadilla');
    INSERT_DIRECCION_DISTRITO_TB_SP(20301, 1, 'Grecia');
    INSERT_DIRECCION_DISTRITO_TB_SP(30801, 1, 'El Tejar');
    INSERT_DIRECCION_DISTRITO_TB_SP(40301, 1, 'Santo Domingo');
    INSERT_DIRECCION_DISTRITO_TB_SP(40302, 1, 'San Vicente');
    INSERT_DIRECCION_DISTRITO_TB_SP(40702, 1, 'La Rivera');
    INSERT_DIRECCION_DISTRITO_TB_SP(40901, 1, 'San Pablo');
    INSERT_DIRECCION_DISTRITO_TB_SP(60205, 1, 'San Jeronimo');
    INSERT_DIRECCION_DISTRITO_TB_SP(60901, 1, 'Parrita');
    INSERT_DIRECCION_DISTRITO_TB_SP(61101, 1, 'Jaco');
END;
/
-- Inserciones FIDE_DIRECCION_TB
BEGIN
    INSERT_DIRECCION_TB_SP(1, 1, 101, 10105, 'Condominio Monteverde, Casa 12');
    INSERT_DIRECCION_TB_SP(1, 1, 101, 10107, 'Residencial Los Robles, Casa 8');
    INSERT_DIRECCION_TB_SP(1, 1, 102, 10203, 'Torre Vista Azul, Apartamento 15B');
    INSERT_DIRECCION_TB_SP(1, 1, 118, 11801, 'Condominio Valle Escondido, Casa 23');
    INSERT_DIRECCION_TB_SP(1, 1, 118, 11802, 'Residencial Altavista, Casa 32');
    INSERT_DIRECCION_TB_SP(1, 2, 203, 20301, 'Condominio Las Lomas, Casa 5');
    INSERT_DIRECCION_TB_SP(1, 3, 308, 30801, 'Villas del Sol, Casa 19');
    INSERT_DIRECCION_TB_SP(1, 4, 403, 40301, 'Condominio Brisas del Lago, Casa 14');
    INSERT_DIRECCION_TB_SP(1, 4, 403, 40302, 'Residencial Hacienda Verde, Casa 7');
    INSERT_DIRECCION_TB_SP(1, 4, 407, 40702, 'Torre Central Park, Apartamento 10C');
    INSERT_DIRECCION_TB_SP(1, 4, 409, 40901, 'Condominio Bosques del Este, Casa 21');
    INSERT_DIRECCION_TB_SP(1, 6, 602, 60205, 'Villas del Bosque, Casa 3');
    INSERT_DIRECCION_TB_SP(1, 6, 609, 60901, 'Residencial Palma Real, Casa 18');
    INSERT_DIRECCION_TB_SP(1, 6, 611, 61101, 'Condominio Mirador del Valle, Casa 9');
    INSERT_DIRECCION_TB_SP(1, 1, 101, 10105, 'Condominio Lomas del Rio, Casa 45');
    INSERT_DIRECCION_TB_SP(1, 1, 101, 10107, 'Residencial La Fuente, Casa 22');
    INSERT_DIRECCION_TB_SP(1, 1, 102, 10203, 'Condominio Puerta del Sol, Casa 17');
    INSERT_DIRECCION_TB_SP(1, 1, 118, 11801, 'Villas del Tropico, Casa 33');
    INSERT_DIRECCION_TB_SP(1, 1, 118, 11802, 'Residencial San Rafael, Casa 2');
    INSERT_DIRECCION_TB_SP(1, 2, 203, 20301, 'Condominio Colinas Verdes, Casa 16');
    INSERT_DIRECCION_TB_SP(1, 3, 308, 30801, 'Residencial Monte Claro, Casa 29');
    INSERT_DIRECCION_TB_SP(1, 4, 403, 40301, 'Condominio El Roble, Casa 5');
    INSERT_DIRECCION_TB_SP(1, 4, 403, 40302, 'Residencial Paraiso Azul, Casa 8');
    INSERT_DIRECCION_TB_SP(1, 4, 407, 40702, 'Torre Aurora, Apartamento 5A');
    INSERT_DIRECCION_TB_SP(1, 4, 409, 40901, 'Residencial Las Brisas, Casa 40');
    INSERT_DIRECCION_TB_SP(1, 6, 602, 60205, 'Condominio del Este, Casa 1');
    INSERT_DIRECCION_TB_SP(1, 6, 609, 60901, 'Residencial Arboleda, Casa 10');
    INSERT_DIRECCION_TB_SP(1, 6, 611, 61101, 'Torre del Sol, Apartamento 3C');
    INSERT_DIRECCION_TB_SP(1, 1, 101, 10105, 'Condominio Vista Verde, Casa 20');
    INSERT_DIRECCION_TB_SP(1, 1, 101, 10107, 'Residencial La Cima, Casa 15');
    INSERT_DIRECCION_TB_SP(1, 1, 102, 10203, 'Condominio La Perla, Casa 10');
    INSERT_DIRECCION_TB_SP(1, 1, 118, 11801, 'Residencial Altos del Mar, Casa 18');
    INSERT_DIRECCION_TB_SP(1, 1, 118, 11802, 'Villas del Sol, Casa 4');
    INSERT_DIRECCION_TB_SP(1, 2, 203, 20301, 'Condominio Paseo Real, Casa 11');
    INSERT_DIRECCION_TB_SP(1, 3, 308, 30801, 'Residencial El Eden, Casa 9');
    INSERT_DIRECCION_TB_SP(1, 4, 403, 40301, 'Condominio El Paraiso, Casa 7');
    INSERT_DIRECCION_TB_SP(1, 4, 403, 40302, 'Residencial Los Angeles, Casa 5');
    INSERT_DIRECCION_TB_SP(1, 4, 407, 40702, 'Condominio Brisas del Mar, Casa 12');
    INSERT_DIRECCION_TB_SP(1, 4, 409, 40901, 'Residencial Los Pinos, Casa 20');
    INSERT_DIRECCION_TB_SP(1, 6, 602, 60205, 'Condominio La Estrella, Casa 13');
    INSERT_DIRECCION_TB_SP(1, 6, 609, 60901, 'Residencial Vista Hermosa, Casa 22');
    INSERT_DIRECCION_TB_SP(1, 6, 611, 61101, 'Condominio Las Palmas, Casa 4');
    INSERT_DIRECCION_TB_SP(1, 1, 101, 10105, 'Residencial El Mirador, Casa 25');
    INSERT_DIRECCION_TB_SP(1, 1, 101, 10107, 'Condominio San Isidro, Casa 16');
    INSERT_DIRECCION_TB_SP(1, 1, 102, 10203, 'Residencial Los Robles, Casa 7');
    INSERT_DIRECCION_TB_SP(1, 1, 118, 11801, 'Villas del Pacifico, Casa 8');
    INSERT_DIRECCION_TB_SP(1, 1, 118, 11802, 'Residencial Santa Fe, Casa 10');
    INSERT_DIRECCION_TB_SP(1, 2, 203, 20301, 'Condominio Palma Real, Casa 18');
    INSERT_DIRECCION_TB_SP(1, 3, 308, 30801, 'Residencial Las Mercedes, Casa 21');
    INSERT_DIRECCION_TB_SP(1, 4, 403, 40301, 'Condominio San Luis, Casa 15');
END;
/
-- Inserciones FIDE_TELEFONO_CONTACTO_TB
BEGIN
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 72938465);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 84576291);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 61237849);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 97856423);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 70543218);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 89321756);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 65439872);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 73214598);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 82163475);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 91238764);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 76584932);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 83475219);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 61928753);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 89765412);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 72389145);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 60873421);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 95438271);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 87321549);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 69283751);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 81294367);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 73645192);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 92185734);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 87593241);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 60382971);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 98473126);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 75831249);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 61987243);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 89562471);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 78231945);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 63758492);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 82937561);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 90481723);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 65293741);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 73186259);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 98436217);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 61879534);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 75219438);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 80496231);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 93715482);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 64291375);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 87352914);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 96583721);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 72839561);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 80367259);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 91234567);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 83475629);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 64528713);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 75849264);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 67291354);
    INSERT_TELEFONO_CONTACTO_TB_SP(1, 83415972);
END;
/
-- Inserciones FIDE_TIPO_USUARIO_TB
BEGIN
    INSERT_TIPO_USUARIO_TB_SP(1, 'Medico');
    INSERT_TIPO_USUARIO_TB_SP(1, 'Asistente');
    INSERT_TIPO_USUARIO_TB_SP(1, 'Recepcion');
    INSERT_TIPO_USUARIO_TB_SP(1, 'Cajero');
    INSERT_TIPO_USUARIO_TB_SP(1, 'Limpieza');
    INSERT_TIPO_USUARIO_TB_SP(1, 'Administracion');
    INSERT_TIPO_USUARIO_TB_SP(1, 'Farmaceutica');
END;
/
-- Inserciones FIDE_ESPECIALIDAD_TB
BEGIN
    INSERT_ESPECIALIDAD_TB_SP(1, 'Cliente', 'Atencion medica basica a animales');
    INSERT_ESPECIALIDAD_TB_SP(1, 'Medicina General', 'Atencion medica basica a animales');
    INSERT_ESPECIALIDAD_TB_SP(1, 'Cirugia General', 'Procedimientos quirurgicos en animales');
    INSERT_ESPECIALIDAD_TB_SP(1, 'Odontologia Veterinaria', 'Tratamiento dental en animales');
    INSERT_ESPECIALIDAD_TB_SP(1, 'Dermatologia Veterinaria', 'Tratamiento de enfermedades de la piel en animales');
    INSERT_ESPECIALIDAD_TB_SP(1, 'Cardiologia Veterinaria', 'Diagnostico y tratamiento de enfermedades cardiacas en animales');
    INSERT_ESPECIALIDAD_TB_SP(1, 'Neurologia Veterinaria', 'Tratamiento de trastornos del sistema nervioso en animales');
    INSERT_ESPECIALIDAD_TB_SP(1, 'Oftalmologia Veterinaria', 'Tratamiento de enfermedades oculares en animales');
    INSERT_ESPECIALIDAD_TB_SP(1, 'Gastroenterologia Veterinaria', 'Tratamiento de enfermedades digestivas en animales');
    INSERT_ESPECIALIDAD_TB_SP(1, 'Oncologia Veterinaria', 'Tratamiento de cancer en animales');
    INSERT_ESPECIALIDAD_TB_SP(1, 'Anestesiologia Veterinaria', 'Administracion de anestesia en animales durante procedimientos quirurgicos');
    INSERT_ESPECIALIDAD_TB_SP(1, 'Radiologia Veterinaria', 'Uso de rayos X y otras imagenes para diagnostico en animales');
END;
/
-- Inserciones FIDE_USUARIOS_TB
BEGIN
     INSERT_USUARIOS_TB_SP(1, 19, 1, 1, 1, 'Julio Calvo', 'juca@clinicahuellitas.com', 'oajeiaid', 182980987, 131257895157);
    INSERT_USUARIOS_TB_SP(1, 22, 2,2, 2, 'Ana Rodriguez', 'arodriguez@clinicahuellitas.com', 'fghy123', 192345678, 131257895158);
    INSERT_USUARIOS_TB_SP(1, 23, 1, 3, 3, 'Carlos Soto', 'csoto@clinicahuellitas.com', 'abc123', 203456789, 131257895159);
    INSERT_USUARIOS_TB_SP(1, 24, 4, 4, 4, 'Maria Fernandez', 'mafer@clinicahuellitas.com', 'qwe5678', 213467890, 131257895160);
    INSERT_USUARIOS_TB_SP(1, 25, 5, 5, 5, 'Luis Herrera', 'lhe@clinicahuellitas.com', 'qazerty1', 223478901, 131257895161);
    INSERT_USUARIOS_TB_SP(1, 26, 6, 6, 6, 'Gabriela Gomez', 'ggo@clinicahuellitas.com', 'asd1234', 233589012, 131257895162);
    INSERT_USUARIOS_TB_SP(1, 27, 7, 7, 7, 'Jose Martinez', 'jmartinez@clinicahuellitas.com', 'abc123', 243690123, 131257895163);
    INSERT_USUARIOS_TB_SP(1, 28, 1, 8, 8, 'Raquel Perez', 'rper@clinicahuellitas.com', '12345abc', 253701234, 131257895164);
    INSERT_USUARIOS_TB_SP(1, 29, 2, 9, 9, 'Felipe Torres', 'ftorres@clinicahuellitas.com', 'zxcvbnm123', 263812345, 131257895165);
    INSERT_USUARIOS_TB_SP(1, 30, 3, 10, 10, 'Patricia Diaz', 'pdiaz@clinicahuellitas.com', 'sdfg123', 273923456, 131257895166);
    INSERT_USUARIOS_TB_SP(1, 21, 7, 11, 11, 'Luis Gomez', 'lgomez@clinicahuellitas.com', 'abc456def', 283034567, 131257895167);
    INSERT_USUARIOS_TB_SP(1, 22, 4, 12, 12, 'Marta Rodriguez', 'mrodriguez@clinicahuellitas.com', 'xy98765', 293145678, 131257895168);
    INSERT_USUARIOS_TB_SP(1, 23, 5, 13, 13, 'Antonio Perez', 'aperez@clinicahuellitas.com', '5ty1abc', 303256789, 131257895169);
    INSERT_USUARIOS_TB_SP(1, 24, 6, 14, 14,'Claudia Sanchez', 'csanchez@clinicahuellitas.com', 'oijklmn987', 313367890, 131257895170);
    INSERT_USUARIOS_TB_SP(1, 25, 1, 15,15,  'Cristian Diaz', 'cdiaz@clinicahuellitas.com', 'sdft1234', 323478901, 131257895171);
    INSERT_USUARIOS_TB_SP(1, 16, 3, 16, 16, 'Natalia Lopez', 'nlopez@clinicahuellitas.com', '12asaQ34', 333589012, 131257895172);
    INSERT_USUARIOS_TB_SP(1, 17, 2, 17, 17, 'Jose Herrera', 'joherrera@clinicahuellitas.com', 'mdss9876', 343690123, 131257895173);
    INSERT_USUARIOS_TB_SP(1, 18, 5, 18, 18, 'Isabel Martinez', 'imartinez@clinicahuellitas.com', 'qwe987', 353701234, 131257895174);
    INSERT_USUARIOS_TB_SP(1, 19, 4, 19, 19 ,'Manuel Garcia', 'mgarcia@clinicahuellitas.com', 'asdf12', 363812345, 131257895175);
    INSERT_USUARIOS_TB_SP(1, 20, 6, 20, 20, 'Paula Gonzalez', 'pgonzalez@clinicahuellitas.com', 'ghj321', 373923456, 131257895176);
    INSERT_USUARIOS_TB_SP(1, 21, 1, 21, 21, 'Diego Morales', 'dmorales@clinicahuellitas.com', 'pass1234', 384034567, 131257895177);
    INSERT_USUARIOS_TB_SP(1, 22, 3, 22, 22, 'Rosa Jimenez', 'rjimenez@clinicahuellitas.com', '1234mno', 394145678, 131257895178);
    INSERT_USUARIOS_TB_SP(1, 23, 2, 23, 23, 'Fernando Castro', 'fcastro@clinicahuellitas.com', 'zxc321', 404256789, 131257895179);
    INSERT_USUARIOS_TB_SP(1, 24, 5, 24,24, 'Elena Rojas', 'erojas@clinicahuellitas.com', 'qwe098', 414367890, 131257895180);
    INSERT_USUARIOS_TB_SP(1, 25, 4, 25, 25, 'Pablo Vargas', 'pvargas@clinicahuellitas.com', 'asd456', 424478901, 131257895181);
    INSERT_USUARIOS_TB_SP(1, 26, 6, 26, 26, 'Camila Mendez', 'cmendez@clinicahuellitas.com', 'lkj987', 434589012, 131257895182);
    INSERT_USUARIOS_TB_SP(1, 27, 7, 27, 27 ,'Oscar Salazar', 'osalazar@clinicahuellitas.com', 'poi123', 444690123, 131257895183);
    INSERT_USUARIOS_TB_SP(1, 28, 1, 28,28,'Monica Espinoza', 'mespinoza@clinicahuellitas.com', 'mnb987', 454701234, 131257895184);
    INSERT_USUARIOS_TB_SP(1, 29, 2, 29,29, 'Ricardo Molina', 'rmolina@clinicahuellitas.com', 'vfr432', 464812345, 131257895185);
    INSERT_USUARIOS_TB_SP(1, 19, 3,30, 30, 'Andrea Herrera', 'aherrera@clinicahuellitas.com', 'tgb321', 474923456, 131257895186);
    INSERT_USUARIOS_TB_SP(1, 21, 7,31, 31, 'Javier Lopez', 'jlopez@clinicahuellitas.com', 'yhn456', 485034567, 131257895187);
    INSERT_USUARIOS_TB_SP(1, 22, 4,32,32, 'Lucia Perez', 'lperez@clinicahuellitas.com', 'ujm789', 495145678, 131257895188);
    INSERT_USUARIOS_TB_SP(1, 23, 5,33, 33, 'Daniel Solis', 'dsolis@clinicahuellitas.com', 'opl321', 505256789, 131257895189);
    INSERT_USUARIOS_TB_SP(1, 24, 6,34,34, 'Carolina Navarro', 'cnavarro@clinicahuellitas.com', 'hji987', 515367890, 131257895190);
    INSERT_USUARIOS_TB_SP(1, 25, 1,35,35, 'Eduardo Vargas', 'evargas@clinicahuellitas.com', 'asd741', 525478901, 131257895191);
    INSERT_USUARIOS_TB_SP(1, 26, 3, 36,36,'Sofia Castillo', 'scastillo@clinicahuellitas.com', 'fgh852', 535589012, 131257895192);
    INSERT_USUARIOS_TB_SP(1, 27, 2, 37,37,'Rodrigo Jimenez', 'rjimenez2@clinicahuellitas.com', 'jkl963', 545690123, 131257895193);
    INSERT_USUARIOS_TB_SP(1, 28, 5,38,38, 'Marcela Pineda', 'mpineda@clinicahuellitas.com', 'zxc852', 555701234, 131257895194);
    INSERT_USUARIOS_TB_SP(1, 18, 4,39,39, 'Guillermo Ortiz', 'gortiz@clinicahuellitas.com', 'bnm963', 565812345, 131257895195);
    INSERT_USUARIOS_TB_SP(1, 19, 6,40,40, 'Natalia Rivera', 'nrivera@clinicahuellitas.com', 'vbn741', 575923456, 131257895196);
    INSERT_USUARIOS_TB_SP(1, 21, 1,41,41, 'Alonso Mejia', 'amejia@clinicahuellitas.com', 'qwe147', 586034567, 131257895197);
    INSERT_USUARIOS_TB_SP(1, 22, 2,42,42, 'Valeria Soto', 'vsoto@clinicahuellitas.com', 'rty258', 596145678, 131257895198);
    INSERT_USUARIOS_TB_SP(1, 23, 3,43,43, 'Sebastian Nunez', 'snunez@clinicahuellitas.com', 'uio369', 606256789, 131257895199);
    INSERT_USUARIOS_TB_SP(1, 24, 4, 44,44, 'Adriana Fuentes', 'afuentes@clinicahuellitas.com', 'asd852', 616367890, 131257895200);
    INSERT_USUARIOS_TB_SP(1, 25, 5,45,45, 'Mauricio Perez', 'mperez@clinicahuellits.com', 'zxc741', 626478901, 131257895201);
    INSERT_USUARIOS_TB_SP(1, 26, 6, 46,46, 'Gabriela Solano', 'gsolano@clinicahuellitas.com', 'vbn963', 636589012, 131257895202);
    INSERT_USUARIOS_TB_SP(1, 27, 7,47,47, 'Leonardo Rojas', 'lrojas@clinicahuellitas.com', 'mnb357', 646690123, 131257895203);
    INSERT_USUARIOS_TB_SP(1, 28, 1, 48,48,'Mariana Espinoza', 'mespinoza2@clinicahuellitas.com', 'yui159', 656701234, 131257895204);
    INSERT_USUARIOS_TB_SP(1, 29, 2,49,49,'Federico Miranda', 'fmiranda@clinicahuellitas.com', 'hjk753', 666812345, 131257895205);
    INSERT_USUARIOS_TB_SP(1, 30, 3, 50,50,'Silvia Araya', 'saraya@clinicahuellitas.com', 'opl951', 676923456, 131257895206);    
END;
--Inserts de especies
BEGIN
