...
PROCEDURE INSERT_DIRECCION_PROVINCIA_TB_SP(
    ...
    FUNCTION OBTENER_DUENNO_MASCOTA_FN (P_ID_MASCOTA NUMBER) 
      ...
      BEGIN
          ...
          IF V_RESULTADO IS NULL OR V_RESULTADO = '' THEN
            RETURN 'NO SE ENCONTRÃ“ DUEÃ‘O PARA LA MASCOTA CON ID ' || P_ID_MASCOTA;
          ELSE
    ...
    BEGIN
        FOR REC IN C_CIRUGIA LOOP
            V_RESULTADO := 'Mascota: ' || REC.NOMBRE_MASCOTA || 
                           ', DiagnÃ³stico previo: ' || REC.CIRUGIA_DIAG_PREVIO || 
                           ', DiagnÃ³stico post: ' || REC.CIRUGIA_DIAG_POST;
        END LOOP;
        
        IF V_RESULTADO IS NULL OR V_RESULTADO = '' THEN
            RETURN 'NO SE ENCONTRÃ“ INFORMACIÃ“N PARA LA CIRUGe?A CON ID ' || P_ID_CIRUGIA;
        ELSE
            RETURN V_RESULTADO;
        END IF;
    ...
    FUNCTION OBTENER_NOMBRE_PRODUCTO_FN(
        ...
        BEGIN
            ...
            IF V_NOMBRE IS NULL OR V_NOMBRE = '' THEN
                RETURN 'NO SE ENCONTRÃ“ PRODUCTO CON ID ' || P_ID_PRODUCTO;
            ELSE
                RETURN V_NOMBRE;
            END IF;
    ...
    BEGIN
        ...
        IF V_NOMBRE IS NULL OR V_NOMBRE = '' THEN
            RETURN 'NO SE ENCONTRÃ“ NOMBRE DEL USUARIO CON EL ID ' || P_ID;
        ELSE
            RETURN V_NOMBRE;
        END IF;
    ...
    BEGIN
        ...
        IF V_PROVEEDOR IS NULL OR V_PROVEEDOR = '' THEN
            RETURN 'NO SE ENCONTRÃ“ PROVEEDOR PARA EL PRODUCTO CON ID ' || P_ID_PRODUCTO;
        ELSE
            RETURN V_PROVEEDOR;
        END IF;
...
---Creacion procedimiento de inserciones para FIDE_ROLES CIRUGIA ------------
  ...
  BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Orden de producto insertada con exito.');
  EXCEPTION
    WHEN OTHERS THEN
  ...
  BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Orden de producto actualizada con exito.');
  EXCEPTION
    WHEN OTHERS THEN
  ...
  BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Orden de producto desactivada con exito.');
  EXCEPTION
    WHEN OTHERS THEN
...
PROCEDURE INSERT_CIRUGIA_MEDICAMENTO_SP(
  ...
  BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Medicamento agregado a cirugia con exito.');
  EXCEPTION
    WHEN OTHERS THEN
      DBMS_OUTPUT.PUT_LINE('Error al insertar: ' || SQLERRM);
  ...
  BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Medicamento de cirugia actualizado con exito.');
  EXCEPTION
    WHEN OTHERS THEN
      DBMS_OUTPUT.PUT_LINE('Error al actualizar: ' || SQLERRM);
  ...
  BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Medicamento desactivado de cirugia con exito.');
  EXCEPTION
    WHEN OTHERS THEN
      DBMS_OUTPUT.PUT_LINE('Error al desactivar: ' || SQLERRM);
...
PROCEDURE INSERT_CIRUGIA_PERSONAL_SP(
  ...
  BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Personal de cirugia agregado con exito.');
  EXCEPTION
    WHEN OTHERS THEN
      DBMS_OUTPUT.PUT_LINE('Error al insertar: ' || SQLERRM);
  END;
...
PROCEDURE UPDATE_CIRUGIA_PERSONAL_SP(
  ...
  BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Personal de cirugia actualizado con exito.');
  EXCEPTION
    WHEN OTHERS THEN
      DBMS_OUTPUT.PUT_LINE('Error al actualizar: ' || SQLERRM);
  END;
  ...
  BEGIN
    ...
    WHERE ID_CIRUGIA_FK = P_ID_CIRUGIA_FK
      ...
      AND ID_ROL_CIRUGIA_FK = P_ID_ROL_CIRUGIA_FK;
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Personal de cirugia desactivado con exito.');
  EXCEPTION
    WHEN OTHERS THEN
      DBMS_OUTPUT.PUT_LINE('Error al desactivar: ' || SQLERRM);
  END;
...
PROCEDURE INSERT_HISTORIAL_MEDICO_SP(
  ...
  BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Historial medico agregado con exito.');
  EXCEPTION
    WHEN OTHERS THEN
      DBMS_OUTPUT.PUT_LINE('Error al insertar: ' || SQLERRM);
  END;
  ...
  BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Historial medico actualizado con exito.');
  EXCEPTION
    WHEN OTHERS THEN
      DBMS_OUTPUT.PUT_LINE('Error al actualizar: ' || SQLERRM);
  ...
  BEGIN
    ...
    WHERE ID_MASCOTA_FK = P_ID_MASCOTA_FK
      AND ID_CONSULTA_FK = P_ID_CONSULTA_FK;
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Historial medico desactivado con exito.');
  EXCEPTION
    WHEN OTHERS THEN
      DBMS_OUTPUT.PUT_LINE('Error al desactivar: ' || SQLERRM);
  END;
  ...
  BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Datos insertados con exito.');
  EXCEPTION
    WHEN NO_DATA_FOUND THEN
      DBMS_OUTPUT.PUT_LINE('No se encontraron registros para insertar.');
    WHEN OTHERS THEN
...
BEGIN
    ...
    PROYECTO_FUNCIONES_PROCEDIMIENTOS_PKG.INSERT_PROVEEDORES_TB_SP(1, 7, 49, 'Paws AND Tails', 'pawsandtails@example.com', 'Collares, correas y accesorios para mascotas', 'Cristopher Vargas', NULL);
...
END;
/
--INSERTS FIDE FACTURA DETALLE
BEGIN
  PROYECTO_FUNCIONES_PROCEDIMIENTOS_PKG.INSERT_DETALLE_FACTURA_SP('Y170425X1-C', 1, 1, 5, 1500, 2, 'VETERINARIA_ADMIN', NULL);
  PROYECTO_FUNCIONES_PROCEDIMIENTOS_PKG.INSERT_DETALLE_FACTURA_SP('D170425Y2-W', 1, 1, 8, 500, 4, 'VETERINARIA_ADMIN', NULL);
  PROYECTO_FUNCIONES_PROCEDIMIENTOS_PKG.INSERT_DETALLE_FACTURA_SP('F170425C3-N', 1, 1, 12, 750, 1, 'VETERINARIA_ADMIN', NULL);
  PROYECTO_FUNCIONES_PROCEDIMIENTOS_PKG.INSERT_DETALLE_FACTURA_SP('L170425B4-K', 1, 1, 3, 1200, 1, 'VETERINARIA_ADMIN', NULL);
  PROYECTO_FUNCIONES_PROCEDIMIENTOS_PKG.INSERT_DETALLE_FACTURA_SP('K170425I5-A', 1, 1, 15, 950, 2, 'VETERINARIA_ADMIN', NULL);
  PROYECTO_FUNCIONES_PROCEDIMIENTOS_PKG.INSERT_DETALLE_FACTURA_SP('Z170425K6-L', 1, 1, 7, 300, 3, 'VETERINARIA_ADMIN', NULL);
  PROYECTO_FUNCIONES_PROCEDIMIENTOS_PKG.INSERT_DETALLE_FACTURA_SP('T170425W7-X', 1, 1, 19, 450, 1, 'VETERINARIA_ADMIN', NULL);
  PROYECTO_FUNCIONES_PROCEDIMIENTOS_PKG.INSERT_DETALLE_FACTURA_SP('O170425R8-V', 1, 1, 2, 2200, 2, 'VETERINARIA_ADMIN', NULL);
  PROYECTO_FUNCIONES_PROCEDIMIENTOS_PKG.INSERT_DETALLE_FACTURA_SP('X170425J9-Y', 1, 1, 10, 1800, 1, 'VETERINARIA_ADMIN', NULL);
  PROYECTO_FUNCIONES_PROCEDIMIENTOS_PKG.INSERT_DETALLE_FACTURA_SP('Q170425Q10-P', 1, 1, 21, 2750, 1, 'VETERINARIA_ADMIN', NULL);
END;
